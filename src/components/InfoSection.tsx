...
const InfoSection = () => {
	const icons = [
		...
		},
		{
			...
			subText: "Granteed Saving",
		},
		{
			icon: BuyersProtection,
			text: "Buyers Protection",
			subText: "Secured payment",
		},

		{
			icon: controledService,
			text: "Customer Service",
			subText: "Give us feedback",
		},
	];
	return (
